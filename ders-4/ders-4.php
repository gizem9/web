...
<ol>
    ...
    <li>echo $diziAdi ile dizi içeriği ekrana yazdırılamaz. Array to String Conversion hatası vereir.Fakat dizinin örneğin 3 indisine sahip elemanı "echo $diziAdi[3]"şeklinde yazdırılabilir.</li>
    <li>Dizinin içerisindeki string ifadeler çift tırnak("")içerisinde yazdırılabilir.</li>
    <li>Dizinin içerisindeki int ifadeler direk yazılabilir.</li>
    <li>Dizinin elemanları birbirinden virgül(,)ile ayrılır.</li>
    <li>Dizi içerisinde indisler varsayılan olarak sıfırdan başlar .</li>
...
echo "dizinin 1. elemanı:" . gettype($dizi1[1]) . "<br>";
echo "dizinin 1. elemanın Türü:" . gettype($dizi1[1]) . "<br>";



echo "dizinin 5. elemanı:" . gettype($dizi1[4]) . "<br>";
echo "dizinin 5. elemanın Türü:" . gettype($dizi1[4]) . "<br>";


echo"Dizin 0. İndisi: <b> $dizi1[0]</b><br>";
echo"Dizin 1. İndisi: <b> $dizi1[1]</b><br>";
echo"Dizin 2. İndisi: <b> $dizi1[2]</b><br>";
echo"Dizin 3. İndisi: <b> $dizi1[3]</b><br>";
echo"Dizin 4. İndisi: <b> $dizi1[4]</b><br>";
echo"Dizin 5. İndisi: <b> $dizi1[5]</b><br>";
